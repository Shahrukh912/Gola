            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="row mb-12">
                <div class="col-12 col-sm-12 col-md-12">
                  ...
                  <input type="hidden" name="html" value="Hi" />
                </div>
                <div class="col-12 col-sm-12 col-md-12">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">GOLA</span>
                </a>
              </div><!-- End Logo -->

              <?php
 
                $result = $db->fetchallpdf();
                  ...
                  while ($row = mysqli_fetch_assoc($result)) {
                    echo '<div class="card-body">';
                      echo '<div class="pt-4 pb-2">';
                        ...
                        echo '<p class="text-center small">'.$row["category"].'</p>';
                      echo '</div>';
                      echo '<form class="row g-3 needs-validation" novalidate action="" method="POST">';
                        echo '<input type="hidden" name="id" value="'.$row["id"].'"/>';
                        echo '<div class="col-12">';
                          echo '<button class="btn btn-primary w-100" type="submit" name="submit">Change Category</button>';
                        echo '</div>';
                      echo '</form>';
                    echo '</div>';
                  }
